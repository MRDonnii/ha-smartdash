...
class HAFjernvarmeHouseCard extends HTMLElement {
  ...
  _render() {
    ...
    const primaryValve=this._entity("primary_valve") ? this._fmt("primary_valve",0) : `CVV ${this._fmt("ch_valve",0)} · BVV ${this._fmt("dhw_valve",0)}`;
